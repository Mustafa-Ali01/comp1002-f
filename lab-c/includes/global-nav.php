<!-- STEP 3: Paste the NAV element code here -->
			...
			<nav>
				<ul>
					<li><a href="lab-c/index.php" title="Go to the Home page">Home</a></li>
					<li><a href="lab-c/red.php" title="Learn about red blocks">Red Blocks</a></li>
					<li><a href="lab-c/blue.php" title="Learn about blue blocks">Blue Blocks</a></li>
					<li><a href="lab-c/yellow.php" title="Learn about yellow blocks">Yellow Blocks</a></li>
					<li><a href="lab-c/green.php" title="Learn about green blocks">Green Blocks</a></li> 
					<li><a href="lab-c/about.php" title="Learn more about us">About</a></li>
				</ul>
			</nav>
